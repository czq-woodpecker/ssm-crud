...
public class EmployeeController {
    ...
    /**
     * ResponseBody要正常工作需要：
     * 导入jackson包：可以将PageInfo对象转换成字符串
     * @param pn
     * @return
     */
    @RequestMapping("/emps")
...
//    @RequestMapping("/emps")
     ...
     *      3.SpringMVC封装POJO对象的时候，会把POJO中每个属性的值request.getParameter("email");
     *
     * AJAX发送PUT请求引发的血案“
     ...
     * 3.request被重新包装，request.getParameter()被重写，就会自己从封装的map中取数据
     *
     *
     * 员工更新方法
     * @param employee
     * @return
     */
//    @RequestMapping(value = "/emp/{id}",method = RequestMethod.PUT)  传过来的叫id  但bean中叫empId
