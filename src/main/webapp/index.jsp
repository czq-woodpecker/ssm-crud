            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  id="email_update_input" placeholder="120@qq.com" name="email">
                            <span  class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" id="gender1_update_input" value="M" name="gender" checked="checked"> 男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" id="gender2_update_input" value="F" name="gender"> 女
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control"  id="email_add_input" placeholder="120@qq.com" name="email">
                            <span  class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" id="gender1_add_input" value="M" name="gender" checked="checked"> 男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" id="gender2_add_input" value="F" name="gender"> 女
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="container">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success:function (result) {
                    ...
                    if(result.code == 100){
                        ...
                        //2.来到最后一页，显示刚才保存的数据
                        //发送ajax请求显示最后一页数据即可
                        to_page(totalRecord);//由于如果刚好记录已经五条，新记录将会在下一页，利用分页插件的合理化参数可以传一个比较大的数字令其显示最新的记录
                    }
                    else {
                        //显示失败信息‘
                        //console.log(result);
                        ...
                        if(undefined != result.extend.errorFields.empName ){
                            //显示员工名字的错误信息
                            show_validate_msg("#empName_add_input","error",result.result.extend.errorFields.empName);
                        }
           ...
           //1.验证邮箱是否合法
            ...
            $.ajax({
               ...
               type:"PUT",
                ...
                data:$("#empUpdateModal form").serialize(),//这种需要配置HttpPutFormContentFilter
                success:function (result) {
                    // alert(result.msg);
                    //1.关闭对话框
        ...
        $("#check_all").click(function () {
            //attr获取check是undefine（属性是后来添加上去的）
